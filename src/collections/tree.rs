...
mod tests {
    ...
    fn new_returns_tree() {
        ...
        assert!(tree.eq(&Tree::<String> {
            right: None,
            left: None,
            phantom: PhantomData::<String>,
            data: Some("hoge".to_string())
        }));
    }
